...
chordlist = {
    ...
    "add9": Chord(
        (C, E, G, D + 12), (C, D, E, F, G, A, D + 12), "Major chord plus 9th (no 7th.)"
    ),
    "addb9": Chord(
        (C, E, G, Db + 12),
        (C, D, E, F, G, A, Db + 12),
    ...
    "m": Chord((C, Eb, G), (C, D, Eb, F, G, Ab, Bb), "Minor triad."),
    "mb5": Chord(
        (C, Eb, Gb), (C, D, Eb, F, Gb, Ab, Bb), "Minor triad with flat 5th (aka dim)."
    ),
    "m#5": Chord(
        (C, Eb, Gs), (C, D, Eb, F, Gs, Ab, Bb), "Minor triad with augmented 5th."
    ),
    "m6": Chord(
        (C, Eb, G, A), (C, D, Eb, F, G, A, Bb), "Minor 6th (flat 3rd plus a 6th)."
    ),
    "m6(add9)": Chord(
        (C, Eb, G, D + 12, A + 12),
        (C, D, Eb, F, G, A, Bb),
    ...
    "m7#5": Chord((C, E, Gs, Bb), (C, D, E, F, Gs, A, Bb), "Minor 7th with sharp 5th."),
    "mM7": Chord(
        (C, Eb, G, B),
        (C, D, Eb, F, G, Ab, B),
    ...
    "7": Chord((C, E, G, Bb), (C, D, E, F, G, A, Bb), "7th."),
    "7(6)": Chord((C, E, G, A, Bb), (C, D, E, F, G, A, Bb), "7th with added 6th."),
    "7b5": Chord((C, E, Gb, Bb), (C, D, E, F, Gb, A, Bb), "7th, flat 5."),
    "dim7": Chord(
        (C, Eb, Gb, Bbb),
    ...
    "aug": Chord((C, E, Gs), (C, D, E, F, Gs, A, B), "Augmented triad."),
    "6": Chord((C, E, G, A), (C, D, E, F, G, A, B), "Major triad with added 6th."),
    "6(add9)": Chord(
        (C, E, G, D + 12, A + 12),
        (C, D, E, F, G, A, B),
    ...
    "M7": Chord((C, E, G, B), (C, D, E, F, G, A, B), "Major 7th."),
    "M7#5": Chord((C, E, Gs, B), (C, D, E, F, Gs, A, B), "Major 7th with sharp 5th."),
    "M7b5": Chord((C, E, Gb, B), (C, D, E, F, Gb, A, B), "Major 7th with a flat 5th."),
    "M7(add6)": Chord((C, E, G, A, B), (C, D, E, F, Gb, A, B), "Major 7th with a 6th."),
    "9": Chord((C, E, G, Bb, D + 12), (C, D, E, F, G, A, Bb), "7th plus 9th."),
    "9b5": Chord(
        (C, E, Gb, Bb, D + 12), (C, D, E, F, Gb, A, Bb), "7th plus 9th with flat 5th."
    ),
    "m9": Chord(
        (C, Eb, G, Bb, D + 12),
        (C, D, Eb, F, G, Ab, Bb),
    ...
    "M9": Chord((C, E, G, B, D + 12), (C, D, E, F, G, A, B), "Major 7th plus 9th."),
    "M9#11": Chord(
        (C, E, G, B, D + 12, Fs + 12),
        (C, D, E, Fs, G, A, B),
        "Major 9th plus sharp 11th.",
    ),
    "7b9": Chord((C, E, G, Bb, Db + 12), (C, Db, E, F, G, A, Bb), "7th with flat 9th."),
    "7b9b13": Chord(
        (C, E, G, Bb, Db + 12, Ab + 12),
        (C, Db, E, F, G, A, Bb),
        "7th with flat 9th and flat 13th.",
    ),
    "7#9": Chord(
        (C, E, G, Bb, Ds + 12), (C, Ds, E, F, G, A, Bb), "7th with sharp 9th."
    ),
    "7#9b13": Chord(
        (C, E, G, Bb, Ds + 12, Ab + 12),
        (C, Ds, E, F, G, Ab, Bb),
        "7th with sharp 9th and flat 13th.",
    ),
    "7b5(add13)": Chord(
        (C, E, Gb, Bb, A + 12), (C, D, E, F, Gb, A, Bb), "7th with flat 5 and 13th."
    ),
    "7(add13)": Chord(
        (C, E, G, Bb, A + 12), (C, D, E, F, G, A, Bb), "7th with added 13th."
    ),
    "7b5b9": Chord(
        (C, E, Gb, Bb, Db + 12),
        (C, Db, E, F, Gb, A, Bb),
    ...
    "+7b9#11": Chord(
        (C, E, Gs, Bb, Db + 12, Fs + 12),
        (C, Db, E, Fs, G, A, Bb),
        "Augmented 7th with flat 9th and sharp 11th.",
    ),
    "m+7b9#11": Chord(
        (C, Eb, Gs, Bb, Db + 12, Fs + 12),
        (C, Db, Eb, Fs, Gs, A, Bb),
    ...
    "M11": Chord(
        (C, E, G, B, D + 12, F + 12), (C, D, E, F, G, Ab, B), "Major 9th plus 11th."
    ),
    "m7(add11)": Chord(
        (C, Eb, G, Bb, F + 12), (C, D, Eb, F, G, Ab, Bb), "Minor 7th  plus 11th."
    ),
    "m9#11": Chord(
        (C, Eb, G, Bb, D + 12, Fs + 12),
        (C, D, Eb, Fs, G, A, Bb),
        "Minor 7th plus 9th and sharp 11th.",
    ),
    "m7b9#11": Chord(
        (C, Eb, G, Bb, Db + 12, Fs + 12),
        (C, Db, Eb, Fs, G, A, Bb),
        "Minor 7th plus flat 9th and sharp 11th.",
    ),
    "m7(add13)": Chord(
        (C, Eb, G, Bb, A + 12), (C, D, Eb, F, G, A, Bb), "Minor 7th  plus 13th."
    ),
    "11b9": Chord(
        (C, E, G, Bb, Db + 12, F + 12),
        (C, Db, E, F, G, A, Bb),
    ...
    "7#9#11": Chord(
        (C, E, G, Bb, Ds + 12, Fs + 12),
        (C, Ds, E, Fs, G, A, Bb),
        "7th plus sharp 9th and sharp 11th.",
    ),
    "7b9#11": Chord(
        (C, E, G, Bb, Db + 12, Fs + 12),
        (C, Db, E, Fs, G, A, Bb),
    ...
    "7sus2": Chord(
        (C, D, G, Bb), (C, D, D, F, G, A, Bb), "A sus2 with dominant 7th added."
    ),
    "sus9": Chord((C, F, G, Bb, D + 12), (C, D, F, F, G, A, Bb), "7sus plus 9th."),
    "13sus": Chord(
        (C, F, G, Bb, D + 12, A + 12), (C, D, F, F, G, A, Bb), "7sus, plus 9th and 13th"
    ),
    "13susb9": Chord(
        (C, F, G, Bb, Db + 12, A + 12),
        (C, Db, F, F, G, A, Bb),
    ...
    "M#11": Chord(
        (C, E, G, B, Fs + 12), (C, D, E, Fs, G, A, B), "Major triad plus sharp 11th."
    ),
    "M13": Chord(
        (C, E, G, B, A + 12),
        (C, D, E, F, G, A, B),
    ...
    "omit3add9": Chord(
        (C, C, G, D + 12), (C, D, E, F, G, A, Bb), "Triad: root, 5th and 9th."
    ),
    "7omit3": Chord((C, C, G, Bb), (C, D, E, F, G, A, Bb), "7th with unvoiced 3rd."),
    "m7omit5": Chord(
        (C, Eb, Bb), (C, D, Eb, F, G, A, Bb), "Minor 7th with unvoiced 5th."
    ),
}
