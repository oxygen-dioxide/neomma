...
class Chord(NamedTuple):
    chord: tuple[int, ...]  # the chord intervals
    scale: tuple[int, ...]  # the associated scale intervals
    description: str                # documentation string for this chord
class Alias(NamedTuple):
    name: str               # the alias name
    target: str             # the chord this is an alias for
    description: str                # documentation string for this alias
C  = 0
Cs = Db = 1
D       = 2
Ds = Eb = 3
...
chordlist = {
    ...
    'add9': Chord((C,    E,    G,    D+12),
             (C, D, E, F, G, A, D+12),
             "Major chord plus 9th (no 7th.)"),

    'addb9': Chord((C,    E,    G,    Db+12),
             (C, D, E, F, G, A, Db+12),
             "Major chord plus flat 9th (no 7th.)"),

    'add#9': Chord((C,    E,    G,    Ds+12),
             (C, D, E, F, G, A, Ds+12),
    ...
    'm6(add9)':    Chord((C, Eb, G, D+12, A+12),
             (C, D, Eb, F, G, A, Bb),
    ...
    'dim7': Chord((C,    Eb,       Gb,       Bbb ),
             (C, D, Eb, F, Gb, Ab, Bbb ),    # missing 8th note
             "Diminished seventh."),
    
    'dim7(addM7)': Chord((C, Eb, Gb, A, B),
             (C, D, Eb, F, Gb, A, B),
             "Diminished triad with added Major 7th."),

    'dim(b13)':  Chord((C, Eb, Gb, Bbb, Ab),
                 (C, D, Eb, F, Gb, Ab, Bbb),
    ...
    'M7(add6)': Chord((C, E, G, A, B),
               (C, D, E, F, Gb, A, B),
               "Major 7th with a 6th."),

    '9':    Chord((C,    E,    G,    Bb, D+12 ),
             (C, D, E, F, G, A, Bb),
             "7th plus 9th."),

 

    '9b5':    Chord((C,    E,    Gb,    Bb, D+12 ),
             (C, D, E, F, Gb, A, Bb),
             "7th plus 9th with flat 5th."),

    'm9':    Chord((C,    Eb,       G,      Bb, D+12 ),
             (C, D, Eb, F, G, Ab, Bb),
             "Minor triad plus 7th and 9th."),

    'm7b5b9': Chord((C, Eb, Gb, Bb, Db+12),
               (C, Db, Eb, F, Gb, Ab, Bb),
               "Minor 7th with flat 5th and flat 9th."),

    'm9b5': Chord((C,    Eb,    Gb, Bb, D+12 ),
             (C, D, Eb, F, Gb, Ab, Bb),
             "Minor triad, flat 5, plus 7th and 9th."),

    'm(sus9)':Chord((C,      Eb,    G,     D+12 ),
               (C, D, Eb, F, G, Ab, D+12),
               "Minor triad plus 9th (no 7th)."),

    'M9':    Chord((C,    E,    G,    B, D+12 ),
             (C, D, E, F, G, A, B),
             "Major 7th plus 9th."),

    'M9#11': Chord((C, E, G, B, D+12, Fs+12),
              (C, D, E, Fs, G, A, B),
              "Major 9th plus sharp 11th."),

    '7b9':    Chord((C,     E,    G,    Bb, Db+12 ),
             (C, Db, E, F, G, A, Bb),
             "7th with flat 9th."),
    
    '7b9b13':    Chord((C,     E,    G,    Bb, Db+12, Ab+12 ),
             (C, Db, E, F, G, A, Bb),
             "7th with flat 9th and flat 13th."),
    
    '7#9':    Chord((C,     E,    G,    Bb, Ds+12 ),
             (C, Ds, E, F, G, A, Bb),
             "7th with sharp 9th."),

    '7#9b13':    Chord((C,     E,    G,    Bb, Ds+12, Ab+12 ),
             (C, Ds, E, F, G, Ab, Bb),
             "7th with sharp 9th and flat 13th."),

    '7b5(add13)':    Chord((C,     E,    Gb,    Bb, A+12 ),
             (C, D, E, F, Gb, A, Bb),
             "7th with flat 5 and 13th."),

    '7(add13)':    Chord((C,     E,    G,    Bb, A+12 ),
             (C, D, E, F, G, A, Bb),
             "7th with added 13th."),

    '7b5b9':Chord((C,     E,    Gb,    Bb, Db+12 ),
             (C, Db, E, F, Gb, A, Bb),
             "7th with flat 5th and flat 9th."),

    '7b5#9':Chord((C,     E,    Gb,    Bb, Ds+12 ),
             (C, Ds, E, F, Gb, A, Bb),
             "7th with flat 5th and sharp 9th."),

    '7#5#9':Chord((C,     E,    Gs,    Bb, Ds+12 ),
             (C, Ds, E, F, Gs, A, Bb),
             "7th with sharp 5th and sharp 9th."),

 
    'aug7': Chord((C,    E,    Gs,    Bb ),
             (C, D, E, F, Gs, A, Bb),
             "An augmented chord (raised 5th) with a dominant 7th."),

    'aug7b9':Chord((C,     E,    Gs,    Bb, Db+12 ),
              (C, Db, E, F, Gs, A, Bb),
              "An augmented chord (raised 5th) with a dominant 7th and flat 9th."),

    'aug7#9':Chord((C,     E,    Gs,    Bb, Ds+12 ),
              (C, Ds, E, F, Gs, A, Bb),
              "An augmented chord (raised 5th) with a dominant 7th and sharp 9th."),

    'aug9M7':Chord((C,     E,    Gs,    B, D+12 ),
              (C, D, E, F, Gs, A, B),
              "An augmented chord (raised 5th) with a major 7th and 9th."),

    '+7b9#11': Chord((C, E, Gs, Bb, Db+12, Fs+12),
                (C, Db, E, Fs, G, A, Bb),
                "Augmented 7th with flat 9th and sharp 11th."),

    'm+7b9#11':  Chord((C, Eb, Gs, Bb, Db+12, Fs+12),
                (C, Db, Eb, Fs, Gs, A, Bb),
                "Augmented minor 7th with flat 9th and sharp 11th."),

    '11':    Chord((C,   C,    G,    Bb, D+12, F+12 ),
             (C, D, E, F, G, A, Bb),
             "9th chord plus 11th (3rd not voiced)."),

    '11+':    Chord((C,   C,    Gs,    Bb, D+12, F+12 ),
             (C, D, E, F, Gs, A, Bb),
             "Augmented 11th (sharp 5)."),
    
    'm11':    Chord((C,    Eb,    G,     Bb, D+12, F+12 ),
             (C, D, Eb, F, G, Ab, Bb),
             "9th with minor 3rd,  plus 11th."),

    'M11':    Chord((C,    E,    G,   B, D+12, F+12 ),
             (C, D, E, F, G, Ab, B),
             "Major 9th plus 11th."),

    'm7(add11)':    Chord((C,    Eb,    G,    Bb, F+12 ),
             (C, D, Eb, F, G, Ab, Bb),
             "Minor 7th  plus 11th."),

    'm9#11':   Chord((C, Eb, G, Bb, D+12, Fs+12),
                (C, D, Eb, Fs, G, A, Bb),
                "Minor 7th plus 9th and sharp 11th."),

    'm7b9#11':  Chord((C, Eb, G, Bb, Db+12, Fs+12),
                (C, Db, Eb, Fs, G, A, Bb),
                "Minor 7th plus flat 9th and sharp 11th."),

    'm7(add13)':    Chord((C,    Eb,    G,    Bb, A+12 ),
             (C, D, Eb, F, G, A, Bb),
             "Minor 7th  plus 13th."),

    '11b9': Chord((C,     E,    G,    Bb, Db+12, F+12 ),
             (C, Db, E, F, G, A, Bb),
             "7th chord plus flat 9th and 11th."),

    '9#5':    Chord((C,    E,    Gs,    Bb, D+12 ),
             (C, D, E, F, Gs, A, Bb),
             "7th plus 9th with sharp 5th (same as aug9)."),

    '9b6':   Chord((C,   E,  Ab, D+12 ),
              (C, D, E, F, Ab, B, D+12),
              "9th with flat 6 (no 5th or 7th)."),
    
    '9#11': Chord((C,    E,     G,    Bb, D+12, Fs+12 ),
             (C, D, E, Fs, G, A, Bb),
             "7th plus 9th and sharp 11th."),

    '7#9#11':Chord((C,     E,     G,    Bb, Ds+12, Fs+12 ),
              (C, Ds, E, Fs, G, A, Bb),
              "7th plus sharp 9th and sharp 11th."),

    '7b9#11': Chord((C,     E,     G,    Bb, Db+12, Fs+12 ),
              (C, Db, E, Fs, G, A, Bb),
              "7th plus flat 9th and sharp 11th."),

    '7#11':Chord((C,    E,     G,    Bb,  Fs+12 ),
             (C, D, E, Fs, G, A, Bb),
             "7th plus sharp 11th (9th omitted)."),

    'M7#11':Chord((C,    E,     G,    B,  Fs+12 ),
             (C, D, E, Fs, G, A, B),
             "Major 7th plus sharp 11th (9th omitted)."),

    'm11b5': Chord((C, Eb, Gb, Bb, D+12, F+12),
              (C, D, Eb, F, Gb, A, Bb),
    ...
    '7sus2':Chord((C,    D,    G,    Bb ),
             (C, D, D, F, G, A, Bb),
             "A sus2 with dominant 7th added."),

    'sus9': Chord((C,    F,    G,    Bb, D+12),
             (C, D, F, F, G, A, Bb),
             "7sus plus 9th."),

    '13sus': Chord((C, F, G, Bb, D+12, A+12),
               (C, D, F, F, G, A, Bb),
               "7sus, plus 9th and 13th"),

    '13susb9': Chord((C, F, G, Bb, Db+12, A+12),
               (C, Db, F, F, G, A, Bb),
    ...
    'omit3add9': Chord((C, C, G, D+12),
               (C, D, E, F, G, A, Bb),
               "Triad: root, 5th and 9th."),

    '7omit3': Chord((C, C, G, Bb),
                (C, D, E, F, G, A, Bb),
                "7th with unvoiced 3rd."),

    'm7omit5': Chord((C, Eb, Bb),
                 (C, D, Eb, F, G, A, Bb),
...
aliases: list[Alias] = [
    Alias('11#5',     '11+',      ''),
    Alias('aug9',     '9#5',      ''),
    Alias('9+',       '9#5',      r'Recommended notation is "+9" or "9\#5"'),
    Alias('+9',       '9#5',      ''),
    Alias('+9M7',     'aug9M7',   ''),
    Alias('+M7',      'M7#5',     ''),
    Alias('m(add9)',  'm(sus9)',  ''),
    ...
    Alias('M6',       '6',        ''),
    Alias('m7-5',     'm7b5',     ''),
    Alias('m7(omit5)','m7omit5',  ''),
    Alias('+',        'aug',      ''),
    Alias('+7',       'aug7',     ''),
    Alias('+7#9',     'aug7#9',   ''),
    Alias('+7b9',     'aug7b9',   ''),
    Alias('7(omit3)', '7omit3',   ''),
    Alias('(#5)',     'aug',      ''),
    Alias('7#5b9',    'aug7b9',   ''),
    Alias('7b9#5',    'aug7b9',   ''),
    Alias('7-9',      '7b9',      ''),
    Alias('7+9',      '7#9',      'Confusing, not recommended.'),
    Alias('maj7',     'M7',       ''),
    Alias('M7-5',     'M7b5',     ''),
    Alias('M7+5',     'M7#5',     'Recommended notation is +M7.'),
    Alias('M7(add13)','13b9',     ''),
    Alias('7alt',     '7b5b9',    'Uses a 7th flat 5, flat 9. Probably not correct, but works (mostly).'),
    Alias('7sus4',    '7sus',     ''),
    Alias('13sus4',   '13sus',    ''),
    Alias('7+',       'aug7',     'An augmented (sharp 5) 7th. Recommended notation is "+7"'),
    Alias('7#5',      'aug7',     'Recommended notation is "+7"'),
    Alias('7+5',      'aug7',     'Recommented notation is "+7"'),
    Alias('7-5',      '7b5',      ''),
    Alias('sus',      'sus4',     ''),
    Alias('maj9',     'M9',       ''),
    Alias('maj13',    'M13',      ''),
    ...
    Alias('msus',     'msus4',    ''),
    Alias('m7sus',    'm7sus4',   ''),
    Alias('dim',      'dim7',     'A dim7, not a triad!'),
    Alias(chr(176),   'dim7',     'A dim7 using a degree symbol'),
    Alias(chr(176)+'3', 'mb5',   'A dim3 (triad) using a degree symbol'),
    Alias(chr(176)+'(addM7)', 'dim7(addM7)', 'dim7(addM7) using degree symbol'),
    Alias(chr(248),   'm7b5',     'Half-diminished using slashed degree symbol'),
    Alias('9sus',     'sus9',     ''),
    Alias('9-5',      '9b5',      ''),
    Alias('dim3',     'mb5',      'Diminished triad (non-standard notation).'),
    Alias('omit3(add9)','omit3add9', ''),
    Alias('9sus4',    'sus9',     ''),
    Alias('7b9sus',   '7susb9',   '')
]
...
for a, b, d in aliases:
    ...
    s = chordlist[b].scale
    if not d:
        d = chordlist[b].description

    chordlist[a] = Chord(n, s, d)
