    ...
    def option(self, ln):
        ...
        for o, v in opts:
            ...
            if o == "EVENT":
                ...
                if self.versenum < 1:
                    error(
                        "Lyric: Attempt to set Verse to %s. Values must be > 0"
                        % self.versenum
                    )
                ...
                self.transpose += neomma.MMA.keysig.getTranspose(
                    [v], "Lyric AddTranspose"
                )
                ...
                error(
                    "Usage: Lyric expecting EVENT, SPLIT, VERSE, CHORDS, TRANSPOSE,"
